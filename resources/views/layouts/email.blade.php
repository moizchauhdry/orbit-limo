            ...
            <tr>
                <td valign="top" align="left" width="100%">
                    ...
                    <table class="w320 full-width-gmail-android"
                        style="border-bottom:solid 2px #b78941;padding-bottom: 10px" cellpadding="0" cellspacing="0"
                        border="0" width="100%">
                        <tbody>
                            <tr>
                    ...
                    <table class="w320 full-width-gmail-android" bgcolor="#f9f8f8" style="background-color:#b78941"
                                                    ...
                                                    <td colspan="3" class="header center" width="100%">
                                                        <p style="color: white;font-size:12px">
                                                            ©{{ Carbon\Carbon::now()->year }} <a
                                                                href="https://orbitlimo.ca/"
                                                                style="color:#fff">orbitlimo.ca</a> All Rights
                                                            Reserved</p>
                                                    </td>
                                                </tr>
                                            </tbody>
