    ...
    <div class="chbs-layout-33x33x33 chbs-clear-fix">
        ...
        <div class="chbs-layout-column-center">
            <div class="chbs-google-map-summary">
                <div id="chbs_google_map" style="height: 534px; position: relative; overflow: hidden;">
                    <div
                        ...
                        <div style="position: absolute; z-index: 0; left: 0px; top: 0px; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px;"
                            ...
                            <div style="position: absolute; z-index: 0; left: 0px; top: 0px; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px; cursor: url(&quot;https://maps.gstatic.com/mapfiles/openhand_8_8.cur&quot;), default; touch-action: pan-x pan-y;"
                                tabindex="0" aria-label="Map" aria-roledescription="map" role="region"
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <span id="A0F179D5-0365-4B51-A76A-EBD4F13B3C7D" style="display: none;">To
                                                navigate, press
                                                the arrow keys.</span>
                                                ...
                                                <span style="display: inline-block;">
                                                    <div
                                                        ...
                                                        <img style="position: absolute; left: 0px; top: 0px; user-select: none; border: 0px none; padding: 0px; margin: 0px; max-width: none; width: 90px; height: 27px;"
                                                            alt="" src="https://maps.gstatic.com/mapfiles/undo_poly.png"
                                                            draggable="false">
                                                    </div>
                                                </span>
                                            </button>
                                ...
                                <div class="LGLeeN-keyboard-shortcuts-view" id="F5BC9846-7CEA-424A-A825-619C1D71A6D8"
                                    style="display: none;">
                                    <table>
                                        <tbody>
                                            <tr>
                            ...
                            <div>
                                <div class="gmnoprint gm-style-mtc"
                                    ...
                                    <button
                                        ...
                                        draggable="false" aria-label="Change map style" title="Change map style"
                                        type="button" aria-haspopup="true" aria-expanded="false"
                                        id="DA4E0C28-84F4-41E3-85AB-F95F7F9CDE05"><span
                                            style="position: relative; right: 3px; top: 0px;">Map</span><img alt=""
                                            src="https://maps.gstatic.com/mapfiles/arrow-down.png" draggable="false"
                                    ...
                                    <ul style="background-color: white; list-style: none; padding: 2px; margin: 0px; z-index: -1; border-bottom-left-radius: 2px; border-bottom-right-radius: 2px; box-shadow: rgba(0, 0, 0, 0.3) 0px 1px 4px -1px; position: absolute; top: 100%; left: 0px; right: 0px; text-align: left; display: none;"
                                        role="menu" aria-labelledby="DA4E0C28-84F4-41E3-85AB-F95F7F9CDE05">
                                        <li style="color: black; font-family: Roboto, Arial, sans-serif; user-select: none; font-size: 18px; background-color: rgb(255, 255, 255); padding: 5px; font-weight: 500;"
                                            draggable="false" title="Show street map" tabindex="-1" role="menuitemradio"
                                        ...
                                        <li style="color: black; font-family: Roboto, Arial, sans-serif; user-select: none; font-size: 18px; background-color: rgb(255, 255, 255); padding: 5px;"
                                            draggable="false" title="Show satellite imagery" tabindex="-1"
                                            role="menuitemradio" aria-checked="false">Satellite</li>
                            ...
                            <div><button
                                    ...
                                    draggable="false" aria-label="Toggle fullscreen view" title="Toggle fullscreen view"
                                    ...
                                    <div class="gmnoprint" data-control-width="40" data-control-height="40"
                                        ...
                                        <div
                                            ...
                                            <button
                                                ...
                                                class="gm-control-active"><img alt="" style="width: 20px; height: 20px;"
                                            ...
                                            <button
                                                ...
                                                draggable="false" aria-label="Tilt map" title="Tilt map" type="button"
                                                class="gm-tilt gm-control-active"><img alt="" style="width: 18px;"
                                    ...
                                    <div class="gmnoprint" style="position: absolute; left: 0px; top: 0px;"
                                        ...
                                        <div draggable="false"
                                            ...
                                            <button
                                                ...
                                                draggable="false" aria-label="Zoom in" title="Zoom in" type="button"
                                            ...
                                            <button
                                                ...
                                                draggable="false" aria-label="Zoom out" title="Zoom out" type="button"
                            ...
                            <div>
                                <div style="display: inline-flex; position: absolute; right: 0px; bottom: 0px;">
                                        ...
                                        <div draggable="false"
                                            ...
                                            <div
                                                ...
                                                <button
                                                    ...
                                                    title="Keyboard shortcuts" type="button"><img
                                    ...
                                    <button
                                        ...
                                        draggable="false" aria-label="Map Scale: 2 m per 71 pixels"
                                        title="Map Scale: 2 m per 71 pixels" type="button" class="gm-style-cc"
                                        ...
                                        <span id="017CB241-435A-421C-A3A0-075423A444CF" style="display: none;">Click
                                            to toggle between
