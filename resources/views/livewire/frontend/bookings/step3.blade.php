                    ...
                    <div class="chbs-box-shadow">
                                ...
                                <div class="iti iti--allow-dropdown iti--separate-dial-code">
                                    <div class="iti__flag-container">
                                        ...
                                        <ul class="iti__country-list iti__hide" id="country-listbox"
                                            aria-expanded="false" role="listbox" aria-activedescendant="iti-item-pk">
                                            <li class="iti__country iti__preferred" tabindex="-1" id="iti-item-us"
                                            ...
                                            <li class="iti__country iti__preferred" tabindex="-1" id="iti-item-gb"
                                            ...
                                            <li class="iti__country iti__standard" tabindex="-1" id="iti-item-kp"
                                                ...
                                                <span class="iti__country-name">North Korea (조선
                                                    민주주의 인민 공화국)</span><span class="iti__dial-code">+850</span>
                                            </li>
                        ...
                        <div class="chbs-clear-fix">
                            <label class="chbs-form-label-group">
                                ...
                                <input type="hidden" name="chbs_client_billing_detail_enable" value="0">
                                Billing address
                            </label>
                        </div>
                        <div class="chbs-client-form-billing-address chbs-panel chbs-hidden">
                            ...
                            <div class="chbs-clear-fix">
                                <div class="chbs-form-field chbs-form-field-width-33">
                                    <label>State</label>
                                    <input type="text" name="chbs_client_billing_detail_state" value="">
                                </div>
                                <div class="chbs-form-field chbs-form-field-width-33">
                                ...
                                <div class="chbs-form-field chbs-form-field-width-33">
                                    <label>Country *</label>
                                    <select name="chbs_client_billing_detail_country_code" id="ui-id-23"
                                        style="display: none;">
                                    ...
                                    <span class="ui-selectmenu-button ui-widget ui-state-default ui-corner-all"
                                        tabindex="0" id="ui-id-23-button" role="combobox" aria-expanded="false"
                                        aria-autocomplete="list" aria-owns="ui-id-23-menu" aria-haspopup="true"
