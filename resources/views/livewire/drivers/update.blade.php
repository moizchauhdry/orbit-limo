<div wire:ignore.self class="modal fade" id="driver_modal" tabindex="-1" role="dialog"
    aria-labelledby="driver_modal_label" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="driver_modal_label">{{$updateMode ? 'Edit' : 'Create'}} Driver</h5>
            </div>
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-floating mb-2">
                        <select wire:model.defer="category" class="form-select" id="category"
