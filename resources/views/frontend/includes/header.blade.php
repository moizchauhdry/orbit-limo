    ...
    <div class="container px-md-5 h-100">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark">
            ...
            <div class="collapse justify-content-end navbar-collapse z-3" id="navbarSupportedContent">
                <ul class="navbar-nav pb-2 mb-lg-0 h-100">
                    ...
                    <div class="tab-pane show active text-white py-2 px-3 w-100">
                        <div class="form-group my-2">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="pickup_location" id="pickup_location"
                                    ...
                                    <span class="input-group-text bg-transparent text-light"><i class="fa-solid fa-location-dot"></i></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group my-2 duration">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-text bg-transparent text-light"><i class="fa-solid fa-clock"></i></span>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="text-white h6" for="datepicker">Date</label>
                            <input id="pickup_date" class="form-control pickup_date" name="pickup_date" placeholder='05-04-2023' />
                        </div>
                        <div class="form-group my-2">
                            <label class="text-white h6" for="formGroupTime">Time</label>
                            <input class="form-control pickup_time" type='text' name="pickup_time" id="pickup_time" data-mdb-toggle="timepicker"
                                placeholder="9:00 AM">
                        </div>
                        <div class="mt-3">
